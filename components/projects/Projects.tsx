...
const projects = [
  {
    ...
    tech: ["Unity", "HLSL", "C#", "Blender", "Shader Graph"],
    description:
      "An indie game that you are trying to guide an 'AI' how to become a 'Human'.",
    modalContent: (
      <>
        <p>
  ...
  },
  {
    ...
    tech: ["Unity", "HLSL", "C#", "Blender", "Shader Graph"],
    description:
      "The dream game that is impossible to finish for me and my team.",
    modalContent: (
      <>
        <p>
